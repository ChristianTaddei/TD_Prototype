...
namespace Tests
{
	public class ConcreteVectorFactoryTests
	{
		ConcreteVectorFactory concreteVectorFactory;

		[SetUp]
		public void Setup()
		{
			concreteVectorFactory = new ConcreteVectorFactory();
		}
		...
		public void vectorFromVec3_vec3_floatRepEqualsVec3()
		{
			...
			Vector v = concreteVectorFactory.VectorFromVec3(vec3);
		...
		public void vectorFromCoords_coords_floatRepCoordsEqualCoords()
		{
			...
			Vector v = concreteVectorFactory.VectorFromCoordinates(c1, c2, c3);
		...
		public void vectorFromCoords_randomCoords_floatRepCoordsEqualCoords(
			...
			[NUnit.Framework.Random(1)] float randomFloat3)
		{
			Vector v = concreteVectorFactory.VectorFromCoordinates(randomFloat1, randomFloat2, randomFloat3);
		...
		{
			ConcreteVector original = new ConcreteVector(1, 2, 3);

			Vector copy = concreteVectorFactory.Copy(original);
