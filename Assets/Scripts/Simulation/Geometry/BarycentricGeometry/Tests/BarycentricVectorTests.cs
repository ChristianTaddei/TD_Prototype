...
/*
    public class BarycentricVectorTests
    {
        ConcreteTriangle regularBase =
            new ConcreteTriangle(
                new ConcreteVector(Vector3.right),
                new ConcreteVector(Vector3.up),
                new ConcreteVector(Vector3.forward));
        ConcreteTriangle randomBase =
            new ConcreteTriangle(
                new ConcreteVector(new Vector3(12.3643634f, -2.124f, -55.123f)),
                new ConcreteVector(new Vector3(3.0f, 1.5f, -0.124f)),
                new ConcreteVector(new Vector3(22.2f, 123.8f, 48.566666666f)));
        ...
        {
            Action<BarycentricVector, ConcreteTriangle> AssertCoordinatesStayTheSame = (bv, otherBase) =>
            {
            ...
            ConcreteTriangle otherRegBase =
                new ConcreteTriangle(
                    new ConcreteVector(new Vector3(0, 1, 0)),
                    new ConcreteVector(new Vector3(0, 0, 1)),
                    new ConcreteVector(new Vector3(1, 0, 0))
                );
