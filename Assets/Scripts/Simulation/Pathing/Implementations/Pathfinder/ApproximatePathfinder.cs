...
public class ApproximatePathfinder : AbstractPathfinder
{
	public ApproximatePathfinder(ApproximateGeometry geometry, PathFactory pathFactory) : base(geometry, pathFactory) { }
